...
#  define MLN_FUNC(ret_type, name, params, args, ...)                               \
    ret_type __##name params __VA_ARGS__ ret_type name params {                     \
...
#else
#  define MLN_FUNC(ret_type, name, params, args, ...) ret_type name params __VA_ARGS__
#  define MLN_FUNC_VOID(ret_type, name, params, args, ...) ret_type name params __VA_ARGS__
#endif
