...
#define __M_SHA1_W(t, wt)                \
  ((wt)[(t)&0xf] = __M_SHA1_ROTATE_LEFT( \
       (wt)[((t)-3) & 0xf] ^ (wt)[((t)-8) & 0xf] ^ (wt)[((t)-14) & 0xf] ^ (wt)[(t)&0xf], 1))

static mln_u32_t k[4] = {0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xCA62C1D6};
...
void mln_sha1_dump(mln_sha1_t *s) {
  printf("%lx %lx %lx %lx %lx\n", (unsigned long)s->H0, (unsigned long)s->H1, (unsigned long)s->H2,
         (unsigned long)s->H3, (unsigned long)s->H4);
}
...
#define mln_sha256_Sigma0256(x) \
  (mln_sha256_S((x), 2) ^ mln_sha256_S((x), 13) ^ mln_sha256_S((x), 22))
#define mln_sha256_Sigma1256(x) \
  (mln_sha256_S((x), 6) ^ mln_sha256_S((x), 11) ^ mln_sha256_S((x), 25))
#define mln_sha256_Gamma0256(x) \
  (mln_sha256_S((x), 7) ^ mln_sha256_S((x), 18) ^ mln_sha256_R((x), 3))
#define mln_sha256_Gamma1256(x) \
  (mln_sha256_S((x), 17) ^ mln_sha256_S((x), 19) ^ mln_sha256_R((x), 10))
  ...
  for (j = 0; j < 64; ++j) {
    if (j >= 16) {
      group[j] = mln_sha256_safe_add(
          mln_sha256_safe_add(mln_sha256_safe_add(mln_sha256_Gamma1256(group[j - 2]), group[j - 7]),
                              mln_sha256_Gamma0256(group[j - 15])),
          group[j - 16]);
    }
    t1 = mln_sha256_safe_add(
        mln_sha256_safe_add(mln_sha256_safe_add(mln_sha256_safe_add(h7, mln_sha256_Sigma1256(h4)),
...
void mln_sha256_dump(mln_sha256_t *s) {
  printf("%lx %lx %lx %lx %lx %lx %lx %lx\n", (unsigned long)s->H0, (unsigned long)s->H1,
         (unsigned long)s->H2, (unsigned long)s->H3, (unsigned long)s->H4, (unsigned long)s->H5,
         (unsigned long)s->H6, (unsigned long)s->H7);
}
